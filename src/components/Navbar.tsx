...
export default function Navbar() {
  return (
    <nav className="w-full bg-[#0B0B0F]/90 backdrop-blur-md border-b border-white/5 sticky top-0 z-50 px-4 sm:px-6 py-4">
      <div className="max-w-7xl mx-auto flex justify-between items-center gap-2">
        
        {/* 🚀 লোগো সেকশন (xs স্ক্রিনে লেখা যেন ব্রেক না করে তার জন্য shrink-0 ও text-lg/xl) */}
        <Link href="/" className="flex items-center gap-2 sm:gap-3 group shrink-0">
          <svg className="w-6 h-6 sm:w-8 sm:h-8 text-brand-neon transition-transform group-hover:scale-105" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className="text-white font-bold text-base sm:text-xl tracking-tight whitespace-nowrap">
            Ankur <span className="text-brand-neon font-light">Biswas</span>
          </span>
        </Link>
        
        {/* 🗺️ মেনু লিংকস (বড় স্ক্রিনের জন্য) */}
        ...
        {/* 💥 সোশ্যাল আইকন এবং গেট এ কোট বাটন */}
        <div className="flex items-center gap-3 sm:gap-5 z-50 shrink-0">
          ...
          {/* 🎯 বাটন (whitespace-nowrap দিয়ে টেক্সট ব্রেক হওয়া বন্ধ করা হয়েছে এবং মোবাইলে প্যাডিং কমানো হয়েছে) */}
          <Link href="#contact" className="bg-brand-neon text-white text-[10px] sm:text-xs font-semibold px-3 py-2 sm:px-5 sm:py-2.5 rounded-md hover:bg-brand-purple transition shadow-glow whitespace-nowrap">
            GET A QUOTE
          </Link>
        </div>
